...
inline int a3keyboardIsChangedASCII(const a3_KeyboardInput *keyboard, const a3_KeyboardKey key)
{
	if (keyboard)
		return (keyboard->keyASCII.key[key] - keyboard->keyASCII0.key[key]);
	return a3input_invalid;
...
inline int a3keyboardGetDifferenceASCII(const a3_KeyboardInput *keyboard, const a3_KeyboardKeyASCII keyPositive, const a3_KeyboardKeyASCII keyNegative)
{
	if (keyboard)
