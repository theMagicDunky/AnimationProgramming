...
//-----------------------------------------------------------------------------
	...
	//	return: 0 if key did not change
	//	return: a3input_invalid if invalid params
	int a3keyboardIsChangedASCII(const a3_KeyboardInput *keyboard, const a3_KeyboardKey key);
	...
	//	return: -1 if negative key is down and positive key is up
	//	return: 0 if both keys have the same state
	int a3keyboardGetDifferenceASCII(const a3_KeyboardInput *keyboard, const a3_KeyboardKeyASCII keyPositive, const a3_KeyboardKeyASCII keyNegative);
