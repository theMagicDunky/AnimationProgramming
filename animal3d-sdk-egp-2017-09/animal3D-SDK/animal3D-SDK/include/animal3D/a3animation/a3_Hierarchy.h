...
//-----------------------------------------------------------------------------
	...
	int a3hierarchyCreate(a3_Hierarchy *hierarchy_out, const unsigned int numNodes, const char **names_opt);
	...
	//	return: -1 if invalid params
	int a3hierarchySetNode(const a3_Hierarchy *hierarchy, const unsigned int index, const int parentIndex, const char name[a3node_nameSize]);
	...
	int a3hierarchyGetNodeIndex(const a3_Hierarchy *hierarchy, const char name[a3node_nameSize]);
	...
	//	return: -1 if invalid params
	int a3hierarchyGetNodeNames(const char *nameList_out[], const a3_Hierarchy *hierarchy);
	...
	//	return: -1 if invalid params
	int a3hierarchyIsParentNode(const a3_Hierarchy *hierarchy, const unsigned int parentIndex, const unsigned int otherIndex);
	...
	//	return: -1 if invalid params
	int a3hierarchyIsChildNode(const a3_Hierarchy *hierarchy, const unsigned int childIndex, const unsigned int otherIndex);
	...
	//	return: boolean, 1 if the node is a parent of the other; 0 if not
	//	return: -1 if invalid params
	int a3hierarchyIsSiblingNode(const a3_Hierarchy *hierarchy, const unsigned int siblingIndex, const unsigned int otherIndex);
	...
	//	return: boolean, 1 if the node is a parent of the other; 0 if not
	//	return: -1 if invalid params
	int a3hierarchyIsAncestorNode(const a3_Hierarchy *hierarchy, const unsigned int ancestorIndex, const unsigned int otherIndex);
	...
	//	return: boolean, 1 if the node is a parent of the other; 0 if not
	//	return: -1 if invalid params
	int a3hierarchyIsDescendantNode(const a3_Hierarchy *hierarchy, const unsigned int descendantIndex, const unsigned int otherIndex);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3hierarchySaveBinary(const a3_Hierarchy *hierarchy, const a3_FileStream *fileStream);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3hierarchyLoadBinary(a3_Hierarchy *hierarchy, const a3_FileStream *fileStream);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3hierarchyCopyToString(const a3_Hierarchy *hierarchy, char *str);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3hierarchyCopyFromString(a3_Hierarchy *hierarchy, const char *str);

	// A3: Get hierarchy stream size.
	//	param hierarchy: non-null pointer to initialized hierarchy
	//	return: number of bytes required to store hierarchy in string
	//	return: -1 if invalid param
	int a3hierarchyGetStringSize(const a3_Hierarchy *hierarchy);

	// A3: Release hierarchy.
	//	param hierarchy: non-null pointer to initialized hierarchy
	//	return: 1 if success
	//	return: -1 if invalid param
	int a3hierarchyRelease(a3_Hierarchy *hierarchy);
