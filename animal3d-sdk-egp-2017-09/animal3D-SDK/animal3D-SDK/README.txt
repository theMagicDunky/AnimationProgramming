...
The supported IDE for Windows is VISUAL STUDIO 2015.
		...
		ii.  Dependencies
The animal3D demo project has TWO (2) external dependencies, and uses one or 
more of the components therein: 
			1. P3DM: Portable 3D Math library
				- A small, C-based math library
				- animal3D uses P3DM headers and its pre-compiled library.
			2. DEV-SDKs: Developer SDK collection
...
3.	Make sure you have P3DM on your computer and have run the install batch 
file therein. **YOUR FRAMEWORK WILL NOT WORK IF YOU DON'T DO THIS!**

4.	To open the framework, run the batch file called "LAUNCH_VS2015.bat" in 
the root folder.
